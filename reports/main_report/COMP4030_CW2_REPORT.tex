...
\begin{figure*}[t!]
  ...
  \begin{subfigure}[t]{0.225\textwidth}
      \centering
      \includegraphics[height=1.25in]{figures/jason_imputation.png}
      \caption{Latitude \& Longitude Mean Imputation}
  \end{subfigure}%
  ~
  \begin{subfigure}[t]{0.225\textwidth}
      \centering
      \includegraphics[height=1.25in]{figures/jason_permit.png}
      \caption{Permit Column After Handling Missing Values}
  \end{subfigure}
  ~
  \begin{subfigure}[t]{0.225\textwidth}
      \centering
      \includegraphics[height=1.25in]{figures/jason_public.png}
      \caption{Public Meeting Column After Handling Missing Values}
  \end{subfigure}
  ~
   \begin{subfigure}[t]{0.225\textwidth}
      \centering
      \includegraphics[height=1.25in]{figures/jason_zones.png}
...
\begin{table}[]
  ...
  \begin{tabular}{|c|c|c|}
    ...
    Column & Category & Count \\
    \hline
    \multirow{11}{*}{Funder} & Other & 37401 \\
    & Gov & 9084 \\
    & Danida & 3114 \\
    & Hesawa & 2203 \\
    & ELCT & 1540 \\
    ...
    & Unknown & 4 \\
    \hline
    \multirow{9}{*}{Installer} & Other & 31825 \\
    & DWE & 17402 \\
    & Gov & 3610 \\
    & Community & 1745 \\
    & Hesawa & 1395 \\
