...
\begin{figure*}[t!]
  \centering
  \includegraphics[height=1.5in]{figures/tom_unknown_cy.png}
  \caption{Construction Year Unknown vs Construction Year Known}
  \label{fig:construction_year_2}
\end{figure*}
